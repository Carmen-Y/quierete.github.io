...
function getDataElements(e){
	if (e.target.classList.contains('pest_btn')){
...
function selectData(prod){
	...
	showAlert('El producto se añadió exitosamente', 'success');
	productsHtml();
	updateCartCount();
	updateTotal();
}
...
function saveLocalStorage() {
	...
	localStorage.setItem('cart', JSON.stringify(productsArray)); // <-- Esta es la clave que usará checkout.html
}
